const assert=require("node:assert/strict");const {percentChange,articleAgeDays,comparePerformance,createReoptimizationTask}=require("../lib/performance-comparison");
assert.equal(percentChange(80,100),-20);assert.equal(percentChange(10,0),null);assert.equal(articleAgeDays("2026-08-01T00:00:00Z",new Date("2026-09-23T00:00:00Z")),53);
